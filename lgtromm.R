...
matchTweets = searchTwitter("LG TROMM", n = 1500, lang = 'en', resultType = "recent")
...
set.seed(1234)
wordcloud(insta_text_corpus, min.freq = 10, max.words = 80, scale = c(2.2,1), colors = brewer.pal(8, "Dark2"), random.color = T, random.order = F)
